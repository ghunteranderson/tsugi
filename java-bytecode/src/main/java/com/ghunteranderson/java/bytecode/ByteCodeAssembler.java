...
public class ByteCodeAssembler {
  ...
  private void writeConstantPoolInfo(AssemblerContext ctx, BinaryWriter out, JConst entry) {
  ...
  private void writeAttributes(AssemblerContext ctx, BinaryWriter out, List<JAttr> attributes) {
  ...
  private void writeAttribute(AssemblerContext ctx, BinaryWriter out, JAttr attribute){
  ...
  private void writeAttributeInfo(AssemblerContext ctx, BinaryWriter out, JAttr attribute){
